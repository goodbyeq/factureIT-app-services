...
public class DistributorProductMapper implements RowMapper<Product> {

	@Override
	public Product mapRow(ResultSet rs, int rowNum) throws SQLException {
		Product product = new Product();
		product.setProductId(rs.getString("distributor_product_id"));
		product.setProductCategoryId(rs.getString("product_category_id"));
		product.setUserType(Constants.DISTRIBUTOR_TYPE);
		product.setUserTypeID(rs.getString("distributor_id"));
